...
Finalized 2026-09-08. Implementation plan: `IMPLEMENTATION_PLAN_v0.1.0.md`.
...
- App: `src-tauri/target/release/bundle/macos/WAKARU.app`
  (arm64, version 0.1.0)
- DMG: `src-tauri/target/release/bundle/dmg/WAKARU_0.1.0_aarch64.dmg`
- Checksum file: `WAKARU_0.1.0_aarch64.dmg.sha256` (basename only)
- Size: `23,078,673` bytes
- SHA-256: `ff0fe62ea067f0856d13289ca90b13b3a049123974e6dca52d7b8cad1819b1cb`
...
`WAKARU backend ready version="0.1.0"` and the log contains no secret patterns.

## Release scope

- Reliable local/LAN streaming and connection capability detection.
- Localized Live Illustrator and text-conversion failure states.
- Existing screen hierarchy, data format, IPC, and capabilities remain in place.
- No project-format or database migration change; existing v0.0.0–v0.0.6 projects
...
2. Tag the release as `v0.1.0` and push the branch and tag.
